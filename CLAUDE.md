...
### Direct Triggers (always invoke `/memory`)

- "log this" / "save this" / "remember this" / "capture this"
- "what did we work on" / "catch me up" / "what was that idea about X"
- "any open threads" / "where did we leave off"
- "wrap up" / "end of session" / "that's it for today"
- "make a note of this" / "I want to keep that idea"

### What NOT to trigger memory for

- Pure code work mid-session with no logging request
- Quick factual or technical questions
- Short one-off tasks with no continuity value
